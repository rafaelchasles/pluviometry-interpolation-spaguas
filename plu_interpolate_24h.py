...
intervalos = [
    (f'https://cth.daee.sp.gov.br/sibh/api/v1/measurements/last_hours_events?hours=24&from_date={hoje_format}T07%3A00&show_all=true', f"ACUMULADO DE CHUVA DAS ÚLTIMAS 24H\n das 07h de {ontem_format} às 07h de {hoje_format}")
